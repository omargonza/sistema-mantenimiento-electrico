...
class OrdenTrabajo(models.Model):
    ...
    vehiculo = models.CharField(max_length=50, blank=True, default="")
    ...
    codigos_luminarias = models.JSONField(default=list, blank=True)
    ...
    luminaria_equipos = models.TextField(blank=True, default="")

    creado = models.DateTimeField(auto_now_add=True)

    # Auditoría / Legal
    observaciones = models.TextField(blank=True, default="")
    firma_tecnico = models.CharField(max_length=120, blank=True, default="")
    firma_supervisor = models.CharField(max_length=120, blank=True, default="")

    # Evidencias (guardamos paths en disco, no base64)
    fotos = models.JSONField(default=list, blank=True)
    firma_tecnico_path = models.CharField(max_length=300, blank=True, default="")
    ...
    def __str__(self):
        return f"OT {self.id} - {self.tablero}"
